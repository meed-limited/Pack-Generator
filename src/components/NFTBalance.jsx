...
function NFTBalance() {
  ...
  // const isPack = (currentElement, nftAdd) => {
  //  if (currentElement === nftAdd) {return true} else {return false};
  // }

  // const isNFTaPack = (nftAdd) => {
  //   if (packCollections.some((e) => e === nftAdd)) {
  //     console.log("true")
          ...
          allBalances.map((nft, index) => (
            <Card
              ...
              actions={[
                ...
                // //isNFTaPack(nft.address)
                // packCollections.some( (address) => address === nft.token_address) && (
                <Tooltip title='Claim Pack'>
                  <KeyOutlined onClick={() => handleClaimClick(nft)} />
                </Tooltip>
                //)
