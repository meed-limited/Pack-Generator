...
const ModalNFT = forwardRef(
  (
    { handleNFTCancel, isModalNFTVisible, handleNFTOk, confirmLoading, isMultiple = false, NFTsPerPage, isPackOnly },
    ref
  ) => {
    ...
    const title = !isPackOnly ? "Select some NFTs to pack:" : "Select a pack to unpack:";
