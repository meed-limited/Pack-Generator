...
function NFTMarketplace({ inputValue, setInputValue }) {
  const fallbackImg =
  ...
  const { NFTMarketplace, totalNFTs, fetchSuccess } = useNFTTokenIds(inputValue);
    ...
    <>
      <div style={{ marginTop: "100px" }}>
        ...
        {inputValue !== "explore" && totalNFTs !== undefined && (
          <>
            ...
            <div style={styles.banner}>
              <Image
                preview={false}
                src={NFTMarketplace[0]?.image || "error"}
        ...
        <div style={styles.NFTs}>
          ...
          {inputValue !== "explore" &&
            NFTMarketplace.slice(0, 20).map((nft, index) => (
              <Card
                hoverable
                size="small"
                actions={[
